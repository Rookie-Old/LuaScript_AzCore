...
local INVTYPE_ROBE                = 20    --[[长袍,就是法系的衣服,和附魔位置有关]]
...
local SlotNames = {   --用来实现多语言,如果后面的为nil,则自动用第一列的文字.
    [EQUIPMENT_SLOT_MAINHAND  ] = {"|TInterface/ICONS/inv_sword_39:35:35|t主手", nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_OFFHAND   ] = {"|TInterface/ICONS/inv_misc_book_05:35:35|t副手", nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_RANGED    ] = {"|TInterface/ICONS/inv_weapon_rifle_01:35:35|t远程", nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_HEAD      ] = {"|TInterface/ICONS/inv_helmet_52:35:35|t头部", nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_SHOULDERS ] = {"|TInterface/ICONS/inv_shoulder_02:35:35|t肩膀", nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_CHEST     ] = {"|TInterface/ICONS/inv_chest_cloth_23:35:35|t胸甲", nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_WRISTS    ] = {"|TInterface/ICONS/inv_bracer_02:35:35|t腕部", nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_HANDS     ] = {"|TInterface/ICONS/inv_gauntlets_16:35:35|t手部", nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_WAIST     ] = {"|TInterface/ICONS/inv_belt_17:35:35|t腰部", nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_LEGS      ] = {"|TInterface/ICONS/inv_pants_08:35:35|t腿部", nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_FEET      ] = {"|TInterface/ICONS/inv_boots_cloth_03:35:35|t脚部", nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_BACK      ] = {"|TInterface/ICONS/inv_misc_cape_18:35:35|t背部", nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_BODY      ] = {"|TInterface/ICONS/inv_shirt_01:35:35|t衬衣", nil, nil, nil, nil, nil, nil, nil, nil},
    [EQUIPMENT_SLOT_TABARD    ] = {"|TInterface/ICONS/inv_shirt_guildtabard_01:35:35|t战袍", nil, nil, nil, nil, nil, nil, nil, nil},
}

local Locales = {      --用来多语言实现,如果后面的为nil,则自动用第一列的文字.
    {"|TInterface/ICONS/spell_nature_astralrecal:35:35|t|cff000000刷新目录......|r", nil, nil, nil, nil, nil, nil, nil, nil},
    {"|TInterface/ICONS/trade_engraving:35:35|t|cffFF0000移除所有部位幻化或隐藏效果|r", nil, nil, nil, nil, nil, nil, nil, nil},
    {"确认移除或隐藏|cffFF0000所有部位|r幻化效果？", nil, nil, nil, nil, nil, nil, nil, nil},
    {"确认用该装备幻化？", nil, nil, nil, nil, nil, nil, nil, nil},
    {"|cffFF0000%s 部位|r确认移除幻化(或隐藏)？", nil, nil, nil, nil, nil, nil, nil, nil},
    {"|TInterface/ICONS/Mail_GMIcon:35:35|t返回部位选择......", nil, nil, nil, nil, nil, nil, nil, nil},
    {"|TInterface/ICONS/trade_engraving:35:35|t|cffFF0000移除当前部位幻化或隐藏效果|r", nil, nil, nil, nil, nil, nil, nil, nil},
    {"已移除所有幻化效果", nil, nil, nil, nil, nil, nil, nil, nil},
    {"不存在任何幻化效果", nil, nil, nil, nil, nil, nil, nil, nil},
    {"%s 的幻化或隐藏效果已移除", nil, nil, nil, nil, nil, nil, nil, nil},
    ...
    {"|TInterface/ICONS/ability_vanish:35:35|t|cffFF0000隐藏当前部位装备|r", nil, nil, nil, nil, nil, nil, nil, nil},
    {"|TInterface/ICONS/ability_vanish:35:35|t|cffFF0000隐藏所有部位装备|r", nil, nil, nil, nil, nil, nil, nil, nil},
}
...
local function OnGossipHello(event, player, creature)
    ...
    player:GossipMenuAddItem(3, "|TInterface/ICONS/inv_sword_39:35:35|t主手", EQUIPMENT_SLOT_END, 15)
    player:GossipMenuAddItem(3, "|TInterface/ICONS/inv_misc_book_05:35:35|t副手", EQUIPMENT_SLOT_END, 16)
    player:GossipMenuAddItem(3, "|TInterface/ICONS/inv_weapon_rifle_01:35:35|t远程武器", EQUIPMENT_SLOT_END, 17)
    player:GossipMenuAddItem(3, "|TInterface/ICONS/inv_helmet_52:35:35|t头", EQUIPMENT_SLOT_END, 0)
    player:GossipMenuAddItem(3, "|TInterface/ICONS/inv_shoulder_02:35:35|t肩膀", EQUIPMENT_SLOT_END, 2)
    player:GossipMenuAddItem(3, "|TInterface/ICONS/inv_chest_cloth_23:35:35|t胸", EQUIPMENT_SLOT_END, 4)
    player:GossipMenuAddItem(3, "|TInterface/ICONS/inv_bracer_02:35:35|t手腕", EQUIPMENT_SLOT_END, 8)
    player:GossipMenuAddItem(3, "|TInterface/ICONS/inv_gauntlets_16:35:35|t手套", EQUIPMENT_SLOT_END, 9)
    player:GossipMenuAddItem(3, "|TInterface/ICONS/inv_belt_17:35:35|t腰带", EQUIPMENT_SLOT_END, 5)
    player:GossipMenuAddItem(3, "|TInterface/ICONS/inv_pants_08:35:35|t腿", EQUIPMENT_SLOT_END, 6)
    player:GossipMenuAddItem(3, "|TInterface/ICONS/inv_boots_cloth_03:35:35|t鞋", EQUIPMENT_SLOT_END, 7)
    player:GossipMenuAddItem(3, "|TInterface/ICONS/inv_misc_cape_18:35:35|t披风", EQUIPMENT_SLOT_END, 14)
    player:GossipMenuAddItem(3, "|TInterface/ICONS/inv_shirt_01:35:35|t衬衣", EQUIPMENT_SLOT_END, 3)
    player:GossipMenuAddItem(3, "|TInterface/ICONS/inv_shirt_guildtabard_01:35:35|t战袍", EQUIPMENT_SLOT_END, 18)
    --[[ --主菜单原栏位循环
...
local function OnGossipSelect(event, player, creature, MenuGroup, MenuID)   --二级菜单
